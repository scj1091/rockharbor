...
<div class="rh-ccbpress-right-column">
	...
	if ( $event->registration_forms ) :  ?>
		...
		<div class="rh-ccbpress-event-registration-forms rh-event-info-box">
			<div class="rh-event-info-box-header clearfix"><div class="rh-event-info-box-icon"><span class="dashicons dashicons-welcome-write-blog"><span></div><div class="rh-ccbpress-event-registration-forms-header rh-event-info-box-header-text"><?php echo "Registration form" . (($event->registration_forms->count() > 1) ? "s" : ""); ?></div></div>
