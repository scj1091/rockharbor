...
<div id="secondary" class="home-widget-area">
	...
	<div class="title white reverse"><h3><?php echo $theme->Html->image('calendar-icon.png', array('parent' => true)); ?>Calendar</h3><a class="title-icon" target="_blank" href="http://core.rockharbor.org/ministries/<?php echo $coreid; ?>"><?php echo $theme->Html->image('out.png'); ?></a></div>
	<div class="body">
		<?php
