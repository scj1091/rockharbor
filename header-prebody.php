...
<link rel="stylesheet<?php if (WP_DEBUG) { echo '/less'; } ?>" media="all" href="<?php echo $theme->info($theme->isChildTheme() ? 'url' : 'base_url'); ?>/css/colors.<?php echo WP_DEBUG ? 'less' : 'css'; ?>" />
