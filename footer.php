...
<footer role="contentinfo">
	<div id="footer">
		<div class="tabs clearfix">
			<a href="#footer" data-tab="#footer .column .first">S</a>
			<a href="#footer" data-tab="#footer .column .second">M</a>
			<a href="#footer" data-tab="#footer .column .third">C</a>
			<a href="#footer" data-tab="#footer .column .last">C</a>
		</div>
		<div class="column">
			<div class="first">
